...
@pytest.mark.asyncio
async def test_list_prompts_with_version_count(client: AsyncClient) -> None:
    ...
    response = await client.get("/prompts", cookies=cookies)
...
@pytest.mark.asyncio
async def test_create_version_auto_increment(client: AsyncClient) -> None:
...
async def test_list_versions(client: AsyncClient) -> None:
    ...
    response = await client.get(f"/prompts/{prompt_id}/versions", cookies=cookies)
